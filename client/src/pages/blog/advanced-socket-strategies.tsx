      ...
      <main className="container mx-auto px-4 py-8 blog-content guide-content">
        ...
        <nav className="mb-6">
          <ol className="flex items-center space-x-2 text-sm text-readable-muted">
            ...
            <li>/</li>
            <li className="text-readable">Advanced Socket Strategies</li>
          </ol>
        </nav>
        ...
        <header className="mb-12">
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            <div className="flex items-center gap-2 content-section rounded-lg px-4 py-2 border border-vibrant-gold/30">
            ...
            <div className="flex items-center gap-2 content-section rounded-lg px-4 py-2 border border-dexterity-green/30">
            ...
            <CardContent>
              ...
              <div className="flex flex-wrap gap-3">
                <Link 
                  ...
                  className="text-poe-gold hover:text-poe-orange transition-colors text-sm font-medium content-section px-3 py-1 rounded"
                >
        ...
        <article className="prose prose-lg max-w-none">
          ...
          <section className="mb-12">
            ...
            <p className="text-readable-muted mb-6 leading-relaxed">
                ...
                <div className="bg-poe-dark rounded-lg p-4">
                  <div className="grid md:grid-cols-2 gap-4 text-sm">
                    <div>
                      ...
                      <div className="text-readable-muted">Expected: 2000+ chromatics</div>
                      <div className="text-readable-muted">Variance: Extremely high</div>
                    </div>
                    <div>
                      <div className="text-dexterity-green font-semibold mb-2">Jeweller Method:</div>
                      <div className="text-readable-muted">Expected: 300 jewellers + 60 chromatics</div>
                      <div className="text-readable-muted">Variance: Much lower</div>
                    </div>
                  </div>
                </div>
              </CardContent>
              ...
              <Card className="content-section border-poe-gold/30">
                ...
                <CardContent>
                  ...
                  <div className="bg-poe-dark rounded-lg p-4">
                    ...
                    <ol className="text-sm text-readable-muted space-y-1">
          ...
          <section className="mb-12">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card className="content-section border-intelligence-blue/30">
                ...
                <CardContent>
                  <p className="text-readable-muted mb-3 text-sm">
          ...
          <section className="mb-12">
            <Card className="bg-gradient-to-r from-poe-gold/20 to-poe-orange/20 border-poe-gold/40">
              <CardContent className="p-8 text-center">
                ...
                <p className="text-readable-muted mb-6 max-w-3xl mx-auto">
