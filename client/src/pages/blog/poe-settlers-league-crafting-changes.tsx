      ...
      <main className="container mx-auto px-4 py-8 blog-content guide-content">
        ...
        <nav className="mb-6">
          <ol className="flex items-center space-x-2 text-sm text-readable-muted">
            ...
            <li>/</li>
            <li className="text-readable">3.25 Crafting Changes</li>
          </ol>
        </nav>
        ...
        <header className="mb-12">
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            <div className="flex items-center gap-2 content-section rounded-lg px-4 py-2 border border-poe-gold/30">
          ...
          <section className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-8 mb-8">
              <Card className="content-section border-dexterity-green/30">
                ...
                <CardContent>
                  <ul className="text-readable-muted space-y-3">
                    <li>
          ...
          <section className="mb-16">
              ...
              <div className="grid md:grid-cols-2 gap-8 mb-6">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="bg-poe-dark rounded-lg p-3">
                        <p className="text-readable-muted text-sm mb-2">Quality Impact on 6-Link:</p>
                ...
                <Card className="content-section border-dexterity-green/30">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <div className="bg-poe-dark rounded-lg p-3">
                        <p className="text-readable-muted text-sm mb-2">Enhanced Quality Impact:</p>
                        <ul className="text-xs text-readable-muted space-y-1">
                          <li>0% Quality: 1/1200 chance</li>
            ...
            <div className="mb-12">
              ...
              <div className="overflow-x-auto mb-6">
                <table className="w-full text-sm content-section border border-poe-gold/30 rounded-lg">
                  <thead>
                  ...
                  <tbody className="text-readable-muted">
            ...
            <div className="mb-12">
              ...
              <p className="text-readable-muted mb-6 text-lg leading-relaxed">
              ...
              <div className="grid md:grid-cols-3 gap-6 mb-8">
                <Card className="content-section border-strength-red/30">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      <p className="text-readable-muted text-sm">Popular builds:</p>
                      <ul className="text-xs text-readable-muted space-y-1">
                      ...
                      <div className="bg-poe-dark rounded-lg p-2 mt-3">
                        ...
                        <p className="text-xs text-readable-muted">Off-color needs: 2-3 blue gems</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <div className="bg-poe-dark rounded-lg p-2 mt-3">
                        ...
                        <p className="text-xs text-readable-muted">Off-color needs: Aura combinations</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      <div className="bg-poe-dark rounded-lg p-2 mt-3">
                        ...
                        <p className="text-xs text-readable-muted">Off-color needs: Movement skills</p>
                      </div>
                    </div>
                  </CardContent>
                </Card>
                ...
                <CardContent className="p-6">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <ul className="text-readable-muted text-sm space-y-1">
            ...
            <div className="space-y-8">
              ...
              <Card className="content-section border-poe-gold/30">
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="text-readable font-semibold mb-3">Recommended Approach:</h4>
                    ...
                    <div>
                      <h4 className="text-readable font-semibold mb-3">Currency Priorities:</h4>
                      <ul className="text-readable-muted space-y-2">
              ...
              <Card className="content-section border-poe-gold/30">
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="text-readable font-semibold mb-3">Adjusted Approach:</h4>
                      <ul className="text-readable-muted space-y-2">
                    ...
                    <div>
                      <h4 className="text-readable font-semibold mb-3">Market Timing:</h4>
                      <ul className="text-readable-muted space-y-2">
              ...
              <Card className="content-section border-poe-gold/30">
                ...
                <CardContent>
                  <div className="grid md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="text-readable font-semibold mb-3">Advanced Techniques:</h4>
                      <ul className="text-readable-muted space-y-2">
                    ...
                    <div>
                      <h4 className="text-readable font-semibold mb-3">Long-term Investments:</h4>
                      <ul className="text-readable-muted space-y-2">
